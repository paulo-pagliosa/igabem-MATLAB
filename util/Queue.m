...
methods
  ...
  function b = contains(this, values)
  % Returns true for each value in VALUES belonging to this queue
    b = ismember(values, this.data(1:this.size));
  end
